...
<div class="well">
	<div class="media">
		<div class="media-left">
			...
			</a> {if $userr.image == NULL}
			<img class="hidden-xs media-object user_profile_pic" src="http://placehold.it/64x64" alt="user_image"> {else}
			<img class="hidden-xs media-object user_profile_pic" src="{$BASE_URL}images/users/{$userr.id}/{$userr.image}" alt="user_image">			{/if}
		</div>
