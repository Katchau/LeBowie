					...
					<div class="media-body question_area">
						...
						<div class="question_coda">
							...
							<div class="question_votes">
								...
								<button id="upvote-btn" type="button" class="btn btn-default" {if !$USERNAME} disabled{/if}>
									<span class="glyphicon glyphicon-thumbs-up" aria-hidden="true">{$question.up_score}</span>
								</button>
								<button id="downvote-btn" type="button" class="btn btn-default" {if !$USERNAME} disabled{/if}>
